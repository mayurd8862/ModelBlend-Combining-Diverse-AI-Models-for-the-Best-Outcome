...
def final_output(model,llm_outputs):
    ...
    (
        "system",
        "You are a highly skilled assistant with expertise in analyzing and synthesizing outputs generated by various large language models (LLMs). "
        "Your goal is to evaluate the provided outputs based on accuracy, relevance, and coherence, and then produce a comprehensive final solution. "
        "Consider the context, logical consistency, and completeness of each output to determine the best possible answer."
    ),
    ("human", f"{llm_outputs}"),
    ]
